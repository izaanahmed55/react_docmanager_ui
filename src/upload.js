...
export const Upload = () => {
  return (
    <>
      ...
      <div className='h-[calc(80vh-20px)] mx-20 flex gap-6 items-center justify-center'>
          ...
          <div className="items-center justify-center w-1/4">
                  ...
                  bg-blue-200 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                          ...
                          <svg ariaHidden="true" className="w-10 h-10 mb-3 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
