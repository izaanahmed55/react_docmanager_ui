        ...
        <>
            <nav className="flex items-center justify-between flex-wrap bg-gray-200 p-6">
                <div className="flex items-center flex-shrink-0 text-white mr-6">
                    ...
                    <span className="font-semibold text-xl text-black tracking-tight">DocManager</span>
                </div>
                ...
                <div className={`w-full ${navbar? "block" : "hidden"}  flex-grow lg:flex lg:items-center lg:w-auto`}>
                    ...
                    <Link to="/upload" className="block mt-4 lg:inline-block lg:mt-0 text-gray-500 hover:text-white mr-4">
                        Upload
                    </Link>
                    </div>
                    <div>
